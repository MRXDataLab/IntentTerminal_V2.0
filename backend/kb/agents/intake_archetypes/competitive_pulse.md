STUDY TYPE: Competitive Pulse (Displacement Study)
...
PILLAR 3 RULE (Target Lens & Decision Goal): Do not ask the client what their hypothesis is. The hypothesis space is generated downstream by a dedicated engine. Instead, probe for what competitive decision this pulse must inform (counter-launch, pricing response, messaging pivot), what winning looks like, and the client's tolerance for acting on incomplete intel.
